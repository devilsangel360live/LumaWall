# 🖼️ LumaWall - Digital Photo Frame & Calendar
...
- 🖼️ **Photo Slideshow** - Display photos from your NAS with dual portrait mode
- 🎨 **Photo Collage** - Randomized artistic layouts
- 🌤️ **Weather Panel** - Current weather, forecast, and interactive radar map (MapTiler)
